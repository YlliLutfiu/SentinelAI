...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Register a new user (role USER) and receive JWT' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login with email and password; receive JWT' }),
